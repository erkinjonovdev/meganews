...
from .models import Category, Banner, Slider, Profile, Tag, SendPost, SendVideo, About, Team, Information, \
    ContactUs, SavedPost
from .serializer import CategorySerializer, BannerSerializer, SliderSerializer, ProfileSerializer, TagSerializer, \
    SendPostSerializer, SendVideoSerializer, AboutSerializer, TeamSerializer, InformationSerializer, \
    ContactUsSerializer, SavedPostSerializer
