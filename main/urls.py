...
from .views import profiles_view, banner_view, slider_view, about_view, information_view, team_view, category_view, \
    tag_view, single_post, send_post, send_video, saved_post, contactus_view, single_category, profile_edit_view, \
    top_post_view, trend_post_view, popular_post_view
